...
if mode == "Test (hardcoded)":
    ...
    st.text("Copy-Paste from your wishlist into the text areas below, priorties 1-25 in the first area & 26-50 in the second; If you select from the middle of the word 'prority' & down to the end of the time of the last event on the list, that should do the job")
